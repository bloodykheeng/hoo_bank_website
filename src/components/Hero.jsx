...
const Hero = () => {
  return (
    <section id='home'
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:pax-0 sm:px-16 px-6`}>
        ...
        <h1 className='font-poppins font-semibold w-full text-white ss:text-[68px] text-[52px] ss:leading-[100px] leading-[75px]'>
          Payment Method.
        </h1>
