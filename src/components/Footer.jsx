  ...
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className="flex-1 flex flex-col justify-start mr-10">
        <img
          src={PesaLogo}
          alt="Elevate Pesa Logo"
          className="w-[266px] h-[72px] object-contain"
        />
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
          You focus on your needs, we’ll handle the rest. At Elevate Pesa, we
          ensure that all your gas and water delivery needs are met with
          efficiency and reliability.
        </p>
      </div>

      <div className="flex-[1.5] w-full flex flex-row  justify-around  md:justify-around lg:justify-end  sm:gap-20 md:gap-10 lg:gap-40  flex-wrap md:mt-0 mt-10">
